...
--DECLARE @SOYAD AS VARCHAR(100)='ÇOLAKOĞLU'
--SELECT @AD+' '+@SOYAD      -->ÖMER ÇOLAKOĞLU
...
--LTRIM,RTRIM,TRIM FONKSIYONLARI -->boşlukları siler

--DECLARE @KELIME AS VARCHAR(100)='    MERHABA DÜNYA   '
--SELECT LTRIM(@KELIME) -->soldaki boşluğu temizledi

--DECLARE @KELIME AS VARCHAR(100)='    MERHABA DÜNYA    '
--SELECT RTRIM(@KELIME) -->sagdaki boşluğu temizledi

--DECLARE @KELIME AS VARCHAR(100)='    MERHABA DÜNYA    '
--SELECT TRIM(@KELIME) -->tüm boşlukları temizledi
...
--DECLARE @KELIME AS VARCHAR(100)='BTK AKADEMİ SQL SERVER EĞİTİMİ'
--SELECT
...
--SELECT DATEPART(DW,@TARIH)  --> haftanın kacıncı gunu?
